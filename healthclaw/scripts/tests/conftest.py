"""Shared pytest fixtures for HealthClaw core unit tests."""
import os
import sys
...
import pytest
from health_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + healthclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full health environment: company, provider, patient, encounter, naming series."""
